...
To build the project, simply download and install Qt version 6 or higher, open the project in Qt Creator, and build it. Only the GCC/MinGW compiler is supported. Qt 5 should also work, but it is not recommended as it has not been tested.

## 🚀 Usage
To get examples, please follow the provided link.
